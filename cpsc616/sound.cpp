  ...
  channels() 
{
 ...
 //    music = Mix_LoadMUS("sound/100Years.mp3");
  ...
  // music = Mix_LoadMUS("sound/ballad2.mid");
   music = Mix_LoadMUS("sound/UpInTheClouds.wav");
      if (!music) {
        throw string("Couldn't load UpInTheClouds.wav")+Mix_GetError();
      //Mix_SetMusicCMD("mpg123 -q");
      //music = Mix_LoadMUS("sound/100Years.mp3");
      }
  //}
  startMusic();
  sounds.push_back( Mix_LoadWAV("sound/win.wav") );
  //sounds.push_back( Mix_LoadWAV("sound/fail.wav") );
  sounds.push_back( Mix_LoadWAV("sound/fire1.wav") );
  sounds.push_back( Mix_LoadWAV("sound/explosions1.wav"));
